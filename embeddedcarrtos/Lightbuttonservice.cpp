...
//   button. If you later swap the light button for a voice command or a
//   CAN message, you only touch this file.
//
...
#define LIGHT_BUTTON_PIN 22   // GPIO connected to manual light toggle button
